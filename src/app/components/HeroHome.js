    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
      ...
      <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
        ...
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          ...
          <div class="flex justify-center space-x-4 mt-14">
          <button className="flex items-center bg-purple-700 text-white hover:bg-blue-500  text-gray-800 font-bold py-2 px-4 rounded mr-6">
      <FontAwesomeIcon icon={faChrome} className="mr-2 text-red-500"/>
      <span>Google Chrome</span>
    </button>
    <button className="flex items-center bg-purple-700 text-white hover:bg-blue-500 text-gray-800 font-bold py-2 px-4 rounded">
      <FontAwesomeIcon icon={faChrome} className="mr-2 text-red-500" />
      <span>Google Chrome</span>
    </button>
</div>
      ...
      {/* Hero image */}
      <Image src={InfoImages} alt='Info Image' width={1000} height={500} className='border-2 border-yellow-500 mt-16'/>
          ...
          <p className="text-xl text-gray-400 mb-8 mt-24" data-aos="fade-up" data-aos-delay="200">
          At Kursor, where we are working on an innovative and futuristic product that is set to revolutionize the way we interact with our computers. redefine the way the cursor works using the cutting-edge technology of GPT.
          </p>
          {/* <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
            <div data-aos="fade-up" data-aos-delay="400">
              <a className="btn text-white bg-purple-900 hover:bg-purple-900 w-full mb-4 sm:w-auto sm:mb-0" href="#0">
                Start free trial
              </a>
            </div>
        ...
        {/* Hero image
        <Image src={InfoImages} alt='Info Image' width={1200} height={130} className='border-2 border-yellow-500'/> */}



        {/* <div>
          <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
            <Image className="mx-auto" src={HeroImage} width="1024" height="504" alt="Hero" />
            <a
