	...
	return (
		<main className="max-w-6xl mx-auto px-4 sm:px-6">
			<div className="bg-black h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-20">
				<div className="p-5 ">
					<ul>
						<p className="text-purple-500 font-bold text-3xl pb-6">
							Kursor
						</p>
            <p className="text-white">Feel the power of AI, get everything on a click at Kursor</p>
			...
			<div className="flex flex-col justify-center items-center text-center  p-5 bg-black">
				<h1 className=" text-gray-800 font-semibold text-white">
					© 2021-2022 All rights reserved | Build with ❤ by{" "}
					<span className="hover:text-blue-600 font-semibold cursor-pointer text-white">
						Kursor{" "}
					</span>
				</h1>
			</div>
...
//                 </Link> */}
//               </div>
//               <div className="text-gray-400">&copy;kursor.in. All rights reserved. </div>
//             </div>
...
//               <li>
//                 <Link href="#" className="flex justify-center items-center text-purple-900 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
...
//               </li>
//               <li className="ml-4">
//                 <Link href="#" className="flex justify-center items-center text-purple-900 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
//                   <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
//               </li>
//               <li className="ml-4">
//                 <Link href="#" className="flex justify-center items-center text-purple-900 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
//                   <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
//               </li>
//               <li className="ml-4">
//                 <Link href="#" className="flex justify-center items-center text-purple-900 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
//                   <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
//               </li>
//               <li className="ml-4">
//                 <Link href="#" className="flex justify-center items-center text-purple-900 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
//                   <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
